let Emoji = {
	...
	emojiPath: 'http://res.purcotton.com/mres/res/base/images/emojiImages/',
    ...
    // console.log(text)
		...
		text = text.replace(Emoji.reg, function(code) {
			return '<img class="emoji" style="vertical-align:middle;display:inline-block;width:20px;height:20px;" src="' + Emoji.emojiPath + Emoji._escapeToUtf32(code) + '.png">';
		});
